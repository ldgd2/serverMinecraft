...
public class TradeClient {
    private static final String API_URL = "http://localhost:8000/api/trades/";
    ...
    public static CompletableFuture<Boolean> completeTrade(int tradeId, String buyerUuid, String buyerName) {
        ...
        return com.lider.minebridge.networking.BackendClient.postJson(API_URL + tradeId + "/complete/", json);
    }
}
