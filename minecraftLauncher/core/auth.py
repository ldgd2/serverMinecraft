...
class AuthController:
    ...
    def update_skin_no_premium(self, player_token, skin_base64=None, skin_value=None, skin_signature=None, force_refresh=False):
        ...
        if force_refresh: payload["force_refresh"] = True
